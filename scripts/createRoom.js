...
// run: npx hardhat run scripts/createRoom.js --network matic
async function main() {
  ...
  await sfRouter.connect(wallet).createRoom().then(function (tx) {
    console.log(`\n\nRoom successfully created. Tx Hash: ${tx.hash}\n`)
  })
}
